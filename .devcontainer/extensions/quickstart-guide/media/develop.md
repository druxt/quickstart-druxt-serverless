...
This starts the Nuxt dev server (auto-starting the Drupal backend first, if it isn't already running) with hot reload - use it to build/preview pages against the live backend before generating static output.
