 ...
 * - Already set up (BASE_URL present in .env): subsequent installs
 *   must not re-provision the site. No OAuth here - this repo has no
 *   simple_oauth/consumers, so BASE_URL alone is the signal.
