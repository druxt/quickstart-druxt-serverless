...
.PHONY: help setup dev build start stop assemble provision generate login xdebug info reset drush
...
help:
	...
	@echo "provision  - Install the site from committed config and Tome content (SQLite)."
	@echo "generate   - Ensure the backend is up, then build full static output (nuxt/dist)."
